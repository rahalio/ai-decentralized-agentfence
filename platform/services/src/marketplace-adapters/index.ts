/**
 * MarketplaceAdapters Services - Application Layer Export
 *
...
/**
 * MarketplaceAdapters Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for marketplace-adapters domain.
 */
