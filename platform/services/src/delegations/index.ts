/**
 * Delegations Services - Application Layer Export
 *
...
/**
 * Delegations Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for delegations domain.
 */
