/**
 * KillSwitch Services - Application Layer Export
 *
...
/**
 * KillSwitch Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for kill-switch domain.
 */
