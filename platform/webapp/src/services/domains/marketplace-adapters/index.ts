/**
 * MarketplaceAdapters Domain
 *
 * Barrel export for marketplace-adapters service, types, hooks, and view models.
 *
 * Architecture Rules:
 * - API types: re-exports from @agentfence/core only
...
// ============================================================================
export { marketplaceAdaptersService } from './marketplace-adapters.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { marketplaceAdaptersFacade } from './facade';
...
export type {} from './marketplace-adapters.api-types';
