 ...
 * AddOns Domain
 *
 * Barrel export for add-ons service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { addOnsService } from './add-ons.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { addOnsFacade } from './facade';
...
export type {} from './add-ons.api-types';
