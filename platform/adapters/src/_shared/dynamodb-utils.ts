 ...
 *
 * @returns The core table name (e.g., "agentfence-core-dev")
 ...
 *
 * @returns The base table name (e.g., "agentfence-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "agentfence-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "agentfence-app-realtime-dev")
