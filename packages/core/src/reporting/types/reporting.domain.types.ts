...
export type GetComplianceExportParams = NonNullable<operations["getComplianceExport"]["parameters"]["query"]>;
...
export type GetComplianceExportResponse = operations["getComplianceExport"]["responses"]["200"]["content"]["application/json"];
